...
\begin{minipage}[!t]{0.33\textwidth}
	...
	\end{picture}
	% 写真の画像ファイルを使う場合( \usepackage[dvipdfmx]{graphicx} をコメントアウトしておくこと )
	%\includegraphics[width=3.0cm]{写真のファイル名.eps}
\end{minipage}
\\
% 住所
...
\begin{tabularx}{174.222mm}{Ic:c|XI}
	...
	\rule[-0.5zw]{0zw}{2zw} yyyy & mm & university 大学 卒業予定 \\	\hline
	\rule[-0.5zw]{0zw}{2zw} yyyy & mm &  \\	\hline
	\rule[-0.5zw]{0zw}{2zw} yyyy & mm &  \\	\hline
	\rule[-0.5zw]{0zw}{2zw} yyyy & mm &  \\	\hline
...
\hlineb
	\multicolumn{1}{IcI}{\rule[-0.5zw]{0zw}{2zw} \bf 志望動機}
	\\	\hline
	%------------------ここに書く-----------------
	...
	\hlineb
%
	\multicolumn{1}{IcI}{\rule[-0.5zw]{0zw}{2zw} \bf 長所・特徴}
	\\ \hline
	1 \\
	2 \\
	3 \\
	...
	\hlineb
%
	\multicolumn{1}{IcI}{\rule[-0.5zw]{0zw}{2zw} \bf 趣味・特技}
	\\ \hline
	1 \\
	2 \\
	3 \\
